...
\fullFrameImage{figures/helicopter/S107G-large.jpg}{
    ...
    \hspace{-17pt}\textcolor{white}{Ph.D. Candidate in Computer Science}
    \vspace{220pt}
...
\frame{
    ...
    \vspace{15pt}
    \onslide<2->
    Undergraduate at MIT studying computer science and electrical engineering.
    
    \vspace{20pt}
    
    \onslide<3->\textbf{Translation}: Brandon will simultaneously:
    \begin{enumerate}
        \item<3-> beat you at Starcraft
        \item<4-> debug your circuit 
        \item<5-> all while also stepping out for a snack at 7-Eleven
    \end{enumerate}
}
...
\frame{
    ...
    Runs a social network analysis company called Proximate (tells event organizers who's meeting each other at their events).
    
    \vspace{20pt}
    
    \onslide<2->\textbf{He can talk your ear off about}:
    \begin{enumerate}
        \item<3-> web software development
        \item<4-> typography
        \item<5-> food
        \item<6-> space
        \item<7-> maps
        \item<8-> Wolfram Alpha
    \end{enumerate}
}
...
\frame{
    ...
    \normalsize
    \vspace{15pt}
    Currently pursuing his masters at MIT in Mechanical Engineering, studying the fluid characteristics of flapping flight.
    
    \vspace{20pt}
    
    \onslide<2->\textbf{Translation}: 
    \begin{enumerate}
        \item<3-> runs unbelievably complex fluid simulations
        \item<4-> retrofitting a swimming-pool sized experimental while he waits
    \end{enumerate}
}
...
\frame{
    \frametitle{Harold}
    \begin{overprint}
    \onslide<2>\includegraphics[width=\textwidth]{figures/people/haroldAnnotated1.pdf}
    \onslide<3>\includegraphics[width=\textwidth]{figures/people/haroldAnnotated2.pdf}
    \onslide<4>\includegraphics[width=\textwidth]{figures/people/haroldAnnotated3.pdf}
    \onslide<5>\includegraphics[width=\textwidth]{figures/people/haroldAnnotated4.pdf}
    \onslide<6>\includegraphics[width=\textwidth]{figures/people/haroldAnnotated5.pdf}
    \end{overprint}
}
